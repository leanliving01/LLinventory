...
export const ROLE_DEFAULTS = {
  ...
  ops_manager: p(
    ...
    'stocktake_view', 'stocktake_create', 'stock_transfers', 'receiving', 'wastage', 'par_levels', 'movements_view',
  ...
  stock_controller: p(
    ...
    'stocktake_view', 'stocktake_create', 'stock_transfers', 'receiving', 'movements_view',
    'po_view', 'po_receive',
    'reports_view',
    'par_levels',
  ),
