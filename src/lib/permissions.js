...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: 'po_approve',  label: 'Approve / Confirm POs' },
      { key: 'po_receive',  label: 'Receive Against POs' },
...
export const ROLE_DEFAULTS = {
  ...
  ops_manager: p(
    ...
    'stocktake_view', 'stocktake_create', 'stock_transfers', 'receiving', 'wastage', 'par_levels', 'movements_view', 'inventory_overview',
  ...
  stock_controller: p(
    ...
    'stocktake_view', 'stocktake_create', 'stock_transfers', 'receiving', 'movements_view', 'inventory_overview',
    'po_view', 'po_receive',
    'reports_view',
    'par_levels',
  ),
...
const LEGACY_MAP = {
  ...
  purchase_orders:      ['po_view', 'po_create', 'po_approve', 'po_receive', 'suppliers'],
