...
export const PERMISSION_GROUPS = [
  ...
  },
  {
    ...
    keys: [
      ...
      { key: 'sales_resends_process', label: 'Process Re-sends' },
      { key: 'returns_manager_approve', label: 'Approve Return/Refund/Re-send Exceptions (manager)' },
...
export const ROLE_DEFAULTS = {
  ...
  ops_manager: p(
    ...
    'sales_view', 'sales_fulfill', 'shopify_returns_process', 'sales_resends_process', 'returns_manager_approve', 'customers',
