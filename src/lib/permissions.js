...
export const ROLE_DEFAULTS = {
  ...
  ops_manager: p(
    ...
    'po_view', 'po_create', 'po_approve', 'grn_create', 'blind_receipt_create', 'product_review', 'product_create_from_queue', 'returns_process', 'supplier_product_edit', 'xero_invoice_sync', 'purchasing_dashboard', 'shortages_view', 'returns_view', 'suppliers',
  ...
  stock_controller: p(
    ...
    'po_view', 'po_create', 'grn_create', 'blind_receipt_create', 'product_review', 'returns_process', 'purchasing_dashboard', 'shortages_view', 'returns_view', 'suppliers',
    'reports_view',
    'par_levels',
  ),
  ...
  viewer: p(
    ...
    'po_view', 'purchasing_dashboard', 'shortages_view', 'returns_view',
