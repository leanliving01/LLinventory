...
const PATH_PERMISSION_MAP = {
  ...
  '/purchasing/credits-returns': 'returns_view',
  ...
  '/stock/adjustments': 'stocktake_view',
...
const navItems = [
  ...
  { 
    ...
    children: [
      ...
      { label: 'Employee Performance', path: '/reports/employees', icon: Users },
  ...
  { label: 'Sync History', path: '/sync-history', icon: RefreshCw },
  { label: 'Bugs', path: '/bugs', icon: Bug },
  { label: 'Settings', path: '/settings', icon: Settings },
];

export default function Sidebar({ collapsed, onToggle, onAiOpen }) {
  const { user } = useAuth();
