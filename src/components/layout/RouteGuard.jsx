...
const ROUTE_PERMISSIONS = {
  ...
  '/purchasing/purchase-orders': 'po_view',
  '/purchasing/workspace': 'po_view',
  ...
  '/stock/adjustments':    'stocktake_create',
  '/stock/stock-take-direct': 'stocktake_create',
  '/stock/stock-take-legacy': 'stocktake_view',
  '/stock/par-levels':     'par_levels',
  '/inventory/dashboard':  'inventory_overview',
  '/sync-history':         'shopify_sync',
