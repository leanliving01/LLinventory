...
/**
 * Compact "what was charged" financial overview for an order. Shared by the
 * Summary dashboard and the Profitability tab so the totals never drift.
 */
export default function FinancialTotals({ order, financialLines = [] }) {
