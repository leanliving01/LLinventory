...
export default function PODetailDrawer({ po, onClose, onUpdated }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-stretch justify-center">
      ...
      <div className="relative z-10 w-full max-w-4xl bg-card shadow-xl flex flex-col">
        {/* Header */}
        ...
        <div className="sticky bottom-0 bg-card border-t border-border px-6 py-4 shrink-0 flex gap-3 flex-wrap relative z-10">
          {editing ? (
            ...
            <>
              ...
              {canCreditNote && (
                <Button variant="outline" onClick={() => setShowCreditNote(true)} className="gap-2 h-10 text-destructive border-destructive/40 hover:bg-destructive/10">
