...
export default function FloorTopBar() {
  ...
  return (
    <header className="bg-card border-b border-border shrink-0 z-30 safe-area-pt">
      <div className="relative h-14 flex items-center justify-between px-4">
        ...
        {/* Center: live clock */}
        <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 font-mono text-sm font-semibold tabular-nums text-foreground/80">
          {clock}
        </span>
