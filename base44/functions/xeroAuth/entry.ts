...
const SCOPES = 'openid profile email offline_access accounting.transactions.read accounting.contacts.read accounting.contacts accounting.invoices accounting.settings.read accounting.attachments.read';
