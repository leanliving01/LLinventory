...
const SCOPES = 'openid profile email offline_access accounting.invoices accounting.invoices.read accounting.payments.read accounting.contacts accounting.contacts.read accounting.settings.read accounting.attachments.read';
